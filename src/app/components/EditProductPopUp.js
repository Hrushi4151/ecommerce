...
const ProductAddPopup = ({ data,eopen = false, seteOpen }) => {
  
  const { fetchProducts} = useContext(Productsdata);
...
const categories = ['Smartphones', 'Laptop','TV', 'Home Appliances', 'Speakers', 'Others'];
  ...
  const handleSubmit = async () => {
    ...
    if(product.name === "" || product.desc === "" || product.price === "" || product.category === "" || product.size === "" || product.color === "" || product.stock === "" ){
        ...
        style: {
          background: "green",
              ...
              Toastify({
                ...
                text: "Failde to Update. Try Again",
                position: "center",
        duration: 2000,
        style: {
          background: "red",
  ...
  return (
    <div>
      <Modal open={eopen} onClose={handleClose}>
        <Box
          sx={{
            position: 'absolute',
            top: '50%',
        ...
        >
          ...
          <TextField
            ...
            name="dprice"
            type="number"
            value={product.dprice ? product.dprice : '00'}
            onChange={handleChange}
            margin="normal"
          />
